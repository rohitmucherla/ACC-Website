          ...
          <table border="1" class="table table-striped">
             ...
             <?php foreach($rows as $row): ?>
                <tr>
                    ...
                    <!-- I name a button so the admin can email the owner from the page using my_mail.php-->
                    <td><?php echo '
                      <a href="#" data-toggle="tooltip" title="'.htmlentities($row['Email'], ENT_QUOTES, 'UTF-8').'">'.htmlentities($row['P_Owner'], ENT_QUOTES, 'UTF-8').'</a>'; ?></td>

                    <td><?php echo htmlentities($row['P_Name'], ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlentities($row['description'], ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlentities($row['Skills'], ENT_QUOTES, 'UTF-8'); ?></td>
                </tr>
             <?php endforeach; ?>
	          <!--
              <tr>
